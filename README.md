...
## CORE COMPETENCIES
- Data, Product & Technology Strategy
- Large‑Scale Team Leadership 
- Cloud & Edge Infrastructure (AWS │ Azure │ GCP) 
- Platform Security & Compliance (ISO 27001, GDPR)
- DevOps & SRE
...
Jan 2023 -- Aug 2024 | New York & Remote
...
- Led technology through Series A--C growth to $3.25 Billion valuation, steering due‑diligence for investors and acquirers.
...
### CollectorIQ -- Interim CTO (Contract)
2017 -- 2018
...
2015 -- 2017
- Architected API and all services for VR title EVE: Valkyrie, supporting launches on PlayStation VR, Oculus and Vive.
...
## SELECT TECHNICAL SKILLS HIGHLIGHTS
Languages: Go · Java · Ocaml · Python · Rust · Swift · TypeScript  
Frameworks: Consul · Nomad · Kubernetes · Docker · Kafka · Terraform  
